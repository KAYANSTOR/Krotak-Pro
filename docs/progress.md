...
- خطة التنفيذ: `docs/ui-build-plan-settings-help.md` (S0 مغلقة → التالي S1 هيكل الإعدادات)
...
1. **الإعدادات + المساعدة (خطة ui-build-plan-settings-help)** — S0 مغلق (PD-07/08). التالي: S1 هيكل الإعدادات → S2 اسم الشبكة Sheet → S3 المفاتيح + الربط + اختبارات → H1 المساعدة.

...
### Phase 43-3 — ملف العميل والدفتر وإضافة/خصم الرصيد (2026-09-21) ✅ برمجيًا

- ملخص دفتر حقيقي: الرصيد، إجمالي الدين، الدفعات، المبيعات، السلف المفتوحة.
- `debit` يدوي عبر `withdrawal` داخل معاملة + Audit + Idempotency.
- شاشة ملف العميل تعرض البيانات والعلاقة بنقطة البيع والحركات بالنوع/الحالة/المصدر.
- إضافة رصيد وخصم/تسوية تتطلبان مبلغاً وسبباً.
- تقرير: [phase-43-3-customer-file.md](phase-43-3-customer-file.md)

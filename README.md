# كروتك Krotak — NET Flutter

تطبيق Android عربي لإدارة بيع كروت الشحن والتحويلات عبر SMS، مع إدارة العملاء والمحافظ ونقاط البيع والمخزون والتقارير. التطبيق **محلي أولاً (Offline-first)**؛ تُحفظ البيانات على الجهاز في قاعدة Drift/SQLite، بينما يتكامل مع Android عبر جسر Native لاستقبال وإرسال الرسائل وتشغيل مهام الاسترداد.

    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(message, style: const TextStyle(fontFamily: 'Tajawal', color: KayanColors.textSecondary)),
        ],
      ),
    );
  }
...
class AsyncEmptyView extends StatelessWidget {
  const AsyncEmptyView({super.key, required this.message, this.icon = Icons.inbox_outlined, this.actionLabel, this.onAction});
  final String message;
  final IconData icon;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(message, textAlign: TextAlign.center, style: const TextStyle(fontFamily: 'Tajawal', color: KayanColors.textSecondary, fontSize: 15)),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(message, textAlign: TextAlign.center, style: const TextStyle(fontFamily: 'Tajawal', color: KayanColors.textPrimary)),
            if (onRetry != null) ...[
              const SizedBox(height: 16),

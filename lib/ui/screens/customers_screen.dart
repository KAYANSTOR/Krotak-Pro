      ...
      builder: (ctx) {
        ...
        return StatefulBuilder(
          builder: (ctx, setModal) {
            return NetSheet(
              title: 'إضافة حساب',
              subtitle: 'أدخل الاسم ورقم الجوال، أو فعّل الرقم البديل لحسابات المحافظ.',
                  ...
                  children: [
                    ...
                    SwitchListTile.adaptive(
                      ...
                      title: const Text(
                        ...
                        style: TextStyle(fontFamily: NetTypography.family, fontSize: 14),
                      ),
                      subtitle: const Text(
                      ...
                      value: useAlt,
                      activeColor: KayanPalette.of(ctx).primary,

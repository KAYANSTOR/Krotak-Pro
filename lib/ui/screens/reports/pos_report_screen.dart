                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return ListTile(
                            ...
                            title: Text(p.name, style: const TextStyle(fontFamily: 'Tajawal', fontWeight: FontWeight.bold)),
                            subtitle: Text('الحالة: ${p.status.name}', style: const TextStyle(fontFamily: 'Tajawal')),
                          );
                        },
                      ),
                    ),

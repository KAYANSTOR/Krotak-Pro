...
/// النسخ الاحتياطي واستعادة البيانات — إعدادات + قاعدة البيانات داخل .krt
...
class _BackupRestoreScreenState extends State<BackupRestoreScreen> {
  ...
  Future<void> _pickAndRestore() async {
    final result = await FilePicker.platform.pickFiles(
      ...
      allowedExtensions: const ['krt', 'znet', 'json'],
      dialogTitle: 'اختيار ملف النسخة (.krt)',
    );
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const NetAppBarTitle(
            ...
            subtitle: 'إعدادات + قاعدة البيانات · ملف .krt',
          ),
        ),
        body: _loading

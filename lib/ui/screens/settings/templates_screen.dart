...
class _TemplatesScreenState extends State<TemplatesScreen> {
  ...
  Future<void> _add() async {
    ...
    final patternCtrl = TextEditingController(
      text: 'تم تحويل {amount} ريال الى {phone} برقم العملية {ref}',
    );
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              maxLines: 3,
              decoration: const InputDecoration(labelText: 'النمط ({amount} {phone} {ref})'),
            ),
          ],
        ),
        actions: [
    ...
    final r = await c.transferTemplates.save(
      TransferTemplate(
        id: c.ids.next('tpl'),

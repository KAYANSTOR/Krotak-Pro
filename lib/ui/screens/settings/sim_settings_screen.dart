...
class _SimSettingsScreenState extends State<SimSettingsScreen> {
  ...
  Future<void> _save() async {
    ...
    await c.settings.save(
      AppSetting(key: SettingKeys.smsListenEnabled, value: _listen.toString(), updatedAt: now),
    );
    if (!mounted) return;
    setState(() => _saving = false);
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('تم الحفظ محليًا', style: TextStyle(fontFamily: 'Tajawal'))),
    );
  }
      ...
      body: _loading
          ...
          : _error != null
              ...
              : ListView(
                  ...
                  children: [
                    const Text(
                      'تُحفظ محليًا (offline-first). لا يتطلب اتصالًا.',
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'فتحة الشريحة المفضلة',

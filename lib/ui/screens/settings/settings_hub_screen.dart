                            ...
                            children: [
                              ...
                              if (_sectionVisible(_walletsKeywords))
                                SettingsGroupCard(children: [
                                  ...
                                  SettingsGroupNavRow(icon: Icons.rule_outlined, title: 'قوالب التحويل', subtitle: 'إدارة قوالب رسائل المحافظ وترتيبها', onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const TemplatesScreen()))),
                                  SettingsGroupSwitchRow(icon: Icons.request_page_outlined, title: 'طلبات رصيد نقاط البيع', subtitle: 'الرد الآلي على استعلام الرصيد', value: true, onChanged: (_) {}),
                                  SettingsGroupSwitchRow(icon: Icons.summarize_outlined, title: 'ملخص العمليات اليومي', subtitle: 'إرسال ملخص يومي تلقائي', value: _dailySummary, onChanged: (v) async { setState(() => _dailySummary = v); await _saveBool(SettingKeys.dailyOpsSummaryAutoSend, v); }),

      ...
      items: [
        _HelpItem(
          ...
          points: const [
            ...
            'المعالجة التلقائية يمكن إيقافها من الإعدادات: تُحفظ الرسائل دون إيداع أو بيع أو إرسال.',
        ...
        _HelpItem(
          ...
          points: const [
            'عند تشغيل الجهاز يُستأنف مسار الاستعادة تلقائياً (BootReceiver + استئناف التطبيق).',
    ...
    _HelpGroup(
      ...
      items: [
        ...
        _HelpItem(
          ...
          iconBg: const Color(0xFF0D9488),
          points: const [
            'نسخة محلية مشفّرة AES-GCM بصيغة .znet — كلمة مرور ≥ 4 أحرف.',

...
void main() {
  ...
  test('merge moves identifiers; both phones resolve to survivor', () async {
    final a = (await customerService.create(
      displayName: 'أ',
      identifierType: CustomerIdentifierType.phoneNumber,
      identifierValue: '+967770000001',
    ) as Success<Customer>)
        .value;
    final b = (await customerService.create(
      displayName: 'ب',
      identifierType: CustomerIdentifierType.phoneNumber,
      identifierValue: '770000002',
    ) as Success<Customer>)
        .value;
    ...
    final res = await resolver.resolve(
      identifierValue: '00967770000001',
      identifierType: TransferIdentifierType.phone,
    );
